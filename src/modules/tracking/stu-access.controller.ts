...
import { StuAccessService } from './stu-access.service';
import { TrackResult } from './tracking.types';

@Controller('s/a')
export class StuAccessController {
  constructor(private readonly trackingService: StuAccessService) {}
